...
|---------------|-------------------|----------------------------|-------------------------------|-----------------------|------------------------------|---------------------------------------------|
| Add 1 item    | 0.236 ms/op       | 0.714 ms/op                | 0.815 ms/op                   |                       |                              | 1.457 ms/op                                 |
| Add 100 items | 1.091 ms/op       | 5.444 ms/op                | 5.670 ms/op                   |                       |                              | 4.856 ms/op                                 |
| Remove 1 item | 0.360 ms/op       | 1.382 ms/op                | 2.075 ms/op                   |                       |                              | 2.014 ms/op                                 |
